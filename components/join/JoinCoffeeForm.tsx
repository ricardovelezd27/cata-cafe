...
import { joinCoffeeForm, type JoinFormState } from "@/app/actions/join";
import { Button } from "@/components/ui";

export type JoinCoffeeFormTranslations = {
  button: string;
  pending: string;
...
/**
 * React 19 useActionState wrapper around joinCoffeeForm (app/actions/join.ts).
 ...
 */
export function JoinCoffeeForm({
  token,
  locale,
  translations: t,
}: {
  token: string;
  locale: string;
  translations: JoinCoffeeFormTranslations;
}) {
